...
import com.assosoft.view.TabServicesView.addForm;
import com.assosoft.view.TabServicesView.updateForm;

public class TabUsersView extends JPanel {
	...
	public TabUsersView(String pAssoSelected) {
		...
		nouvtab.AjouterColonne("Code Postal");
		nouvtab.AjouterColonne("Mail");
		nouvtab.AjouterColonne("Date Inscription");
...
//		gbc.gridy = -1;
//
//		addChildPanel(formPanel, gbc, lblNom, txtNom, lblPrenom, txtPrenom, lblRue, txtRue, lblVille, txtVille,
//				lblCodePostal, txtCodePostal, lblDateInscription, txtDateInscription, lblPassword, txtPassword,
//				lblActif, txtActif, lblRoot, txtRoot, lblContact, txtContact);
...
//		add(formPanel, gc);
		...
		btnAdd.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				clearFormPanel(txtNom, txtPrenom, txtRue, txtVille, txtCodePostal, txtDateInscription,
						txtPassword, txtActif, txtRoot, txtContact);
		...
		btnDelete.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				boolean valid = MainDAO.validateForm(txtNom, txtPrenom, txtRue, txtVille, txtCodePostal, txtDateInscription,
						txtPassword, txtActif, txtRoot, txtContact);
...
//						DonDAO.delDon(Integer.parseInt(txtNumDon.getText()));
		...
		btnUpdate.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				if (nouvtab.getSelectedRow() == -1) {
					JOptionPane.showMessageDialog(null, "Veuillez sélectionnez une ligne pour modifier.",
							"Information", JOptionPane.INFORMATION_MESSAGE);
				} else {
					JDialog dialog = new JDialog();
	...
	public void fillTable(String assoName) {
		...
		this.nouvtab = UserDAO.readUsersAsso(this.nouvtab, assoId);
	}
