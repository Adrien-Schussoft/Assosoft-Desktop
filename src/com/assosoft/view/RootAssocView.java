...
public class RootAssocView extends JPanel {
...
//		gbc.gridy = -1;
//
//		addChildPanel(formPanel, gbc, lblNom, txtNom, lblRue, txtRue, lblVille, txtVille, lblCodePostal, txtCodePostal,
//				lblLogo, txtLogo, lblActif, txtActif, lblNumAsso, txtNumAsso);
////		formPanel.setLayout(new BoxLayout(formPanel, BoxLayout.Y_AXIS));
////		formPanel.setAlignmentY(Component.TOP_ALIGNMENT);
////		Dimension dim = new Dimension(30, 10);
////		lblNom.setMaximumSize(dim);
////		lblNom.setPreferredSize(dim);
//
//		// create a hidden label and set anchor to south
//		// this make the extra space distributed in center
...
////				lblHidden.setBorder(border);
//		formPanel.add(lblHidden, gbc);
